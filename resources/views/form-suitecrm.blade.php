...
<div class="row">
<div class="col"><label>Nombre: <span class="required">*</span></label><input name="last_name" id="last_name" type="text" required="" /></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
<div class="row">
<div class="col"><label>Cédula: </label><input name="cedula_c" id="cedula_c" type="number" /></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
<div class="row">
<div class="col"><label>Teléfono: </label><input name="telefono_c" id="telefono_c" type="numer" /></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
<div class="row">
<div class="col"><label for="sexo_c">Sexo:</label>
...
<div class="row">
<div class="col"><label>Fecha de nacimiento: </label><input name="fecha_nacimiento_c" id="fecha_nacimiento_c" type="date" /></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
<div class="row">
<div class="col"><label>Dirección: </label><span class="sugarslot"><textarea name="direccion_c" id="direccion_c"   /> </textarea></span></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
<div class="row">
<div class="col"><label>Provincia: </label><input name="provincia_c" id="provincia_c" type="text" /></div>
<div class="col"> </div>
<div class="clear"> </div>
</div>
