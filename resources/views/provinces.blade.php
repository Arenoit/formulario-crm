...
@section('content')
    ...
    <form class="js-validate" action="{{ route('send-province') }}" method="post" enctype="multipart/form-data"
        id="form-id">
        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn--container justify-content-center">
                                                    ...
                                                    href="{{ route('edit-provincia', $province->id) }}" title="Editar Provincia"><i class="tio-edit"></i>
                                                    </a>
                                                    <a href="javascript:;" 
